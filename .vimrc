...
let g:go_gocode_bin="$HOME/Go/bin/gocode"
let g:go_goimports_bin="$HOME/Go/bin/goimports"
let g:go_godef_bin="$HOME/Go/bin/godef"
let g:go_oracle_bin="$HOME/Go/bin/oracle"
let g:go_golint_bin="$HOME/Go/bin/golint"
